...
![[Pasted image 20260831123547.png]]在训练时，每个机器的负载会不同，某些专家会被多次选上，从而导致剩余的专家没被充分训练，论文提出三个辅助损失负载平衡方法：
...
**● FP8混合精度训练框架**
![[Pasted image 20260831181026.png]]在不同规模的模型上应用FP8训练，并与传统的BF16训练对比，验证FP8训练框架的有效性和准确性。
